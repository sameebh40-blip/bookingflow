...
export default function FilterServiceTypeScreen() {
  ...
  const handleClear = useCallback(() => {
    console.log('[FilterServiceType] Clear pressed');
    setSelected(new Set());
  }, []);
