...
export default function NotificationPreferencesScreen() {
  ...
  const handleEnableNotifications = async () => {
    console.log("[NotificationPreferences] Enable notifications pressed, permissionDenied:", permissionDenied);
    if (permissionDenied) {
      ...
      Alert.alert(
        ...
        [
          { text: "Cancel", style: "cancel", onPress: () => console.log("[NotificationPreferences] Settings alert cancelled") },
          {
            text: "Open Settings",
            onPress: () => {
