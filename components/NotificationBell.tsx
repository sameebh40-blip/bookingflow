...
export function NotificationBell({
  ...
  const handlePress = async () => {
    ...
    if (permissionDenied) {
      ...
      console.log("[NotificationBell] Permission previously denied, prompting settings");
      Alert.alert(
        "Notifications Disabled",
        "To receive notifications, please enable them in your device settings.",
        [
          { text: "Cancel", style: "cancel", onPress: () => console.log("[NotificationBell] Settings alert cancelled") },
          {
            text: "Open Settings",
            onPress: () => {
